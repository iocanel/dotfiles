...
kitty --title "Auxiliary Terminal" -e bash -c "mkdir -p ~/workspace/src/github.com/$ORGANIZATION; cd ~/workspace/src/github.com/$ORGANIZATION; git clone $CLONE_URL_SSH; exec fish"
popd
