...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-leader/set-key "d s" 'demo-it-start)
  (evil-leader/set-key "d e" 'demo-it-end)
  (evil-leader/set-key "d p" 'demo-it-step)
  (evil-leader/set-key "d q" 'demo-it-presentation-quit)
  (evil-leader/set-key "d a" 'demo-it-presentation-advance)
#+END_SRC
*** Email
**** mu4e
***** package
...
***** Prompt
      #+BEGIN_SRC emacs-lisp
        ...
        (setq eshell-highlight-prompt t):1
      #+End_SRC
...
**** Capture
     #+BEGIN_SRC emacs-lisp
       (setq org-capture-templates
             '(("a" "Appointment" entry (file  "~/Documents/notes/gcal.org" ) "* %?\n\n%^T\n\n:PROPERTIES:\n\n:END:\n\n")
               ("l" "Link" entry (file+headline "~/Documents/notes/links.org" "Links") "* %? %^L %^g \n%T" :prepend t)
               ("t" "To Do Item" entry (file+headline "~/Documents/notes/todo.org" "To Do") "* TODO %?\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n%a\n" :prepend t)
...
***** Java
      #+BEGIN_SRC emacs-lisp
        (use-package lsp-java
          :load-path "~/workspace/src/github.com/emacs-lsp/lsp-java"
          :init
