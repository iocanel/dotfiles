...
**** Hydra    
     #+BEGIN_SRC emacs-lisp
       (setq eide-function-alist '((eide-open-function . projectile-switch-project)
       ...
       (defun python-ide()
         ...
         (add-to-list 'eide-function-alist '(eide-indent . python-indent))
         )
       ...
       (defun golang-ide()
         ...
         (add-to-list 'eide-function-alist '(eide-optimize-imports . goimports))
         (add-to-list 'eide-function-alist '(eide-indent . gofmt))
         )
       ...
       (defvar ignore-current-buffer)
       (setq eide-back-stack ())
       (setq eide-forward-stack ())
       ...
       (defvar eide-tab-width)
       (setq eide-tab-width 4)
       (defvar eide-use-tabs)
       ...
       (defhydra eide-hydra (:hint nil :exit t)
         "
               ...
               ^^^^^^-------------------------------------------------------------------------------------------------------
                 _O_ open      _o_ optimize imports     _?_: declaration   _g_: grep             _r_: run/eval     _1_: ide
                 _R_ recent    _i_ indent               _/_: references    _f_: find file        _t_: run test     _2_: side by side
                 _C_ close     _r_ indent region        _<_: back          _v_: find variable                    _3_: repl 
                 _B_ build     _I_ toggle tab width     _>_: forward                                           _0_: terminal 
                 _V_ vcs       _T_ toggle use tabs      _._: set mark
                               _@_ copyright
                 "
