...
**** Bindings
     #+BEGIN_SRC emacs-lisp
       (define-key evil-normal-state-map (kbd "C-k o") 'kubernetes-overview)
       (define-key evil-normal-state-map (kbd "C-k o") 'kubernetes-overview)
       (define-key evil-normal-state-map (kbd "C-k r c") 'kubernetes-create-from-buffer)
       (define-key evil-normal-state-map (kbd "C-k r d") 'kubernetes-delete-from-buffer)
       (define-key evil-normal-state-map (kbd "C-k r r") 'kubernetes-replace-from-buffer)
       (define-key evil-normal-state-map (kbd "C-k p e") 'kubernetes-exec-into)
       (define-key evil-normal-state-map (kbd "C-k e") 'kubernetes-execute-marks)
       (define-key evil-normal-state-map (kbd "C-k d") 'kubernetes-mark-for-delete)
       (define-key evil-normal-state-map (kbd "C-k j d") 'kubernetes-portforward)
     #+END_SRC
*** Jenkins
