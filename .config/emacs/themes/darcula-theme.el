...
(defcustom darcula-background
  "#262626" ;; custom background to match my desktop
...
(custom-theme-set-faces
 ...
 '(link ((t (:weight normal :slant normal :underline (:color foreground-color :style line) :inverse-video nil :foreground "#3e86a0"))))
 ...
 '(mode-line ((t (:weight normal :slant normal :underline nil :box nil :inverse-video nil))))
 '(mode-line-inactive ((t (:weight normal :slant normal :underline nil :box nil :inverse-video nil :inherit (mode-line)))))
 '(mode-line-buffer-id ((t (:weight bold))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((((class color) (min-colors 88))) (t (:inherit (highlight)))))
 '(powerline-active2 ((t (:weight normal :slant normal :underline nil :box nil :inverse-video nil))))
 '(powerline-inactive2 ((t (:weight normal :slant normal :underline nil :box nil :inverse-video nil))))
